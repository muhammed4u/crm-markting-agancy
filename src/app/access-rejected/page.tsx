...
export default function AccessRejectedPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center bg-slate-900 text-slate-100 p-6 relative overflow-hidden">
      ...
      <div className="absolute bottom-[-10%] right-[-10%] w-[400px] h-[400px] bg-red-500/10 rounded-full blur-[100px] pointer-events-none" />
      ...
      <div className="w-full max-w-md bg-slate-900/50 border border-slate-800 backdrop-blur-md rounded-2xl shadow-2xl p-8 z-10 text-center space-y-6">
        <div className="flex justify-center">
          <div className="w-16 h-16 rounded-full bg-rose-600/10 border border-rose-500/20 flex items-center justify-center text-rose-400 animate-bounce">
            <ShieldAlert className="w-8 h-8" />
          </div>
        </div>

        <div className="space-y-2">
          <h2 className="text-xl font-bold text-white">Access Scope Rejected</h2>
          <p className="text-sm text-slate-400 leading-relaxed">
            Your application or registration status has been rejected or disabled by the platform administrators.
          </p>
        </div>

        <div className="p-4 bg-slate-950/40 border border-slate-800/80 rounded-xl text-xs text-slate-400 text-left space-y-2">
          <span className="font-bold text-rose-400 block">Need assistance?</span>
          <p>• If you believe this is a mistake, please contact the academy support desk.</p>
          <p>• Make sure you submitted correct identifying details or enrollment information.</p>
          <p>• You can log out to access a different active account.</p>
        </div>
